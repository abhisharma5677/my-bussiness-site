      ...
      <div className={style.form_container}>
        <form ref={form} onSubmit={sendEmail}>
          <div className={style.form_group}>
            <label className={style.form_label} htmlFor="name">Name:</label>
          ...
          <div className={style.form_group}>
            <label className={style.form_label} htmlFor="user_email">Email:</label>
          ...
          <div className={style.form_group}>
            <label className={style.form_label} htmlFor="user_phone">Phone:</label>
